...
if [ -z "$private_subnet" ] || [ -z "$private_subnet_two" ]; then
    echo "Subnet information missing - all subnets needed (Private)"
    exit 1
fi
...
-var "private-subnet"=$private_subnet -var "private-subnet2"=$private_subnet_two
